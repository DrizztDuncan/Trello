export default function BoardHeader() {
  const boardHeaderBTN = [
    {
      btn_name: "basic board",
      btn_content: <div className="text-sky-50">Basic Board</div>,
    },
    { btn_name: "template", btn_content: "template" },
    {
      btn_name: "stared",
      btn_content: (
        <svg
